...
inline fun <T> T.require(requirement: T.() -> Boolean, message: String = "$this does not match requirements", noinline elseBlock: T.() -> Unit = {}): T =
    require(requirement, IllegalArgumentException(message), elseBlock)
...
inline fun String?.requireNotBlank(throwable: Throwable = IllegalArgumentException("cannot be blank"), noinline elseBlock: () -> Unit = {}): String =
    if (!isNullOrBlank()) this!! else {
        run(elseBlock.andThrow(throwable))
    }
...
inline fun <T> Collection<T>.requireNotEmpty(throwable: Throwable = IllegalArgumentException("cannot be empty"), noinline elseBlock: Collection<T>.() -> Unit = {}): Collection<T> =
    require({ isNotEmpty() }, throwable, elseBlock)

inline fun <T> Collection<T>.requireNotEmpty(message: String = "cannot be empty", noinline elseBlock: Collection<T>.() -> Unit = {}): Collection<T> =
...
inline fun <T> Array<T>.requireNotEmpty(throwable: Throwable = IllegalArgumentException("cannot be empty"), noinline elseBlock: Array<T>.() -> Unit = {}): Array<T> =
    require({ isNotEmpty() }, throwable, elseBlock)

inline fun <T> Array<T>.requireNotEmpty(message: String = "cannot be empty", noinline elseBlock: Array<T>.() -> Unit = {}): Array<T> =
    requireNotEmpty(IllegalArgumentException(message), elseBlock)
...
inline fun <T> Collection<T>.requireSize(size: Int, message: String = "must be of size $size", noinline elseBlock: Collection<T>.() -> Unit = {}): Collection<T> =
...
fun Byte.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultByte()}"), elseBlock: () -> Unit = {}): Byte =
    require({ this != defaultByte() }, throwable, { run(elseBlock) })
...
fun Short.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultShort()}"), elseBlock: () -> Unit = {}): Short =
    require({ this != defaultShort() }, throwable, { run(elseBlock) })
...
fun Int.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultInt()}"), elseBlock: () -> Unit = {}): Int =
    require({ this != defaultInt() }, throwable, { run(elseBlock) })
...
fun Long.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultLong()}"), elseBlock: () -> Unit = {}): Long =
    require({ this != defaultLong() }, throwable, { run(elseBlock) })
...
fun Float.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultFloat()}"), elseBlock: () -> Unit = {}): Float =
    require({ this != defaultFloat() }, throwable, { run(elseBlock) })
...
fun Double.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultDouble()}"), elseBlock: () -> Unit = {}): Double =
    require({ this != defaultDouble() }, throwable, { run(elseBlock) })
...
fun String.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultString()}"), elseBlock: () -> Unit = {}): String =
    require({ this != defaultString() }, throwable, { run(elseBlock) })
...
fun BigInteger.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultBigInteger()}"), elseBlock: () -> Unit = {}): BigInteger =
    require({ this != defaultBigInteger() }, throwable, { run(elseBlock) })

fun BigInteger.requireNonDefault(message: String = "cannot be ${defaultBigInteger()}", elseBlock: () -> Unit = {}): BigInteger =
...
fun BigDecimal.requireNonDefault(throwable: Throwable = IllegalArgumentException("cannot be  ${defaultBigDecimal()}"), elseBlock: () -> Unit = {}): BigDecimal =
    require({ this != defaultBigDecimal() }, throwable, { run(elseBlock) })

fun BigDecimal.requireNonDefault(message: String = "cannot be ${defaultBigDecimal()}", elseBlock: () -> Unit = {}): BigDecimal =
    requireNonDefault(IllegalArgumentException(message), elseBlock)
